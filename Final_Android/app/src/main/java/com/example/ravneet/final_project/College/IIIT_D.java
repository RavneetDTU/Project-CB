...
public class IIIT_D extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iiit__d);

        postAdd = (Button)findViewById(R.id.btn_postadd_iitd);

        postAdd.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(IIIT_D.this, BookPostActivity.class);
                startActivity(i);
            }
        });
    }
